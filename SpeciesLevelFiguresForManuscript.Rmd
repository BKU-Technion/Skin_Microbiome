...
The workspace includes the abundance data from two seperate sequencing experiments as well as the design of the experiment as is described in the manuscript. 
...
dds <- DESeqDataSetFromMatrix(countData = counts(ExpressionSet2),
                              ...
                              design = ~ W_1 + W_2 + W_3 + W_4 + W_5+
                              W_6 + W_7 + W_8 + W_9 + W_10 + W_11 + W_12 + 
                              W_13 + W_14 + W_15 + RUVseq)
